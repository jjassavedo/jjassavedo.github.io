# Assavedo Jeffrey Portfolio

Static portfolio site. The homepage is `index.html`; styling and interactions are in `site.css` and `site.js`.

## Image uploads

Create an `images/` folder at the repository root and upload JPG files using these names. Missing files show a labeled placeholder until the image is added.
...
Use the same spelling and lowercase filenames. Pages are built to render placeholders where an asset has not been uploaded yet.
...
GitHub Pages can publish this repository at `https://jjassavedo.github.io/` when Pages is enabled for the `main` branch.
